...
p.nominalBounds = new cjs.Rectangle(0,0,1935,1920);
...
(lib.SpinBtn = function() {
	this.initialize(img.SpinBtn);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,551,164);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.SpinBtn();
	this.instance.setTransform(-275.5,-82);
...
p.nominalBounds = new cjs.Rectangle(-275.5,-82,551,164);
...
if (reversed == null) { reversed = false; }
	...
	this.BTN.name = "BTN";
	this.BTN.setTransform(1538.5,1758);
	...
	this.instance.setTransform(922,114);

	this.instance_1 = new lib.Logo();
	this.instance_1.setTransform(784,739);
...
p.nominalBounds = new cjs.Rectangle(952,960,975,960);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"BG.png?1758526511234", id:"BG"},
		{src:"Logo.png?1758526511234", id:"Logo"},
		{src:"Pointer.png?1758526511234", id:"Pointer"},
		{src:"SpinBtn.png?1758526511234", id:"SpinBtn"},
		{src:"Stand.png?1758526511234", id:"Stand"},
		{src:"Wheel.png?1758526511234", id:"Wheel"}
	],
	preloads: []
};
